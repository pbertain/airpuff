...
FILEPATH="/var/www/vhosts/airpuff/html/fli-rite"
...
for AIRPORT in ${AIRPORTS} ; do
    ...
    SKY_COVERAGE=`grep -i ${AIRPORT} /var/fli-rite/data/metars_current.csv | awk -F, '{ print $23,$24,$25,$26,$27,$28 }'`
...
/bin/logger "Fli-Rite run complete at `date` for ${REGION}."
